...
dim = 10
ss = StandardScaler()
new_datas = ss.fit_transform(DLPs)
pca = PCA(n_components=dim)
pca.fit(new_datas)

pca_90 = PCA(n_components=1)
dim_1 = pca_90.fit_transform(new_datas).shape[1]
print(dim_1)
...
draw_PCA(dim, [dim_1, dim_95, dim_99],
