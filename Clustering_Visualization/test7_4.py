...
hierarchy.dendrogram(Z, labels=None, color_threshold=Y.max()*0.3,
                     leaf_rotation=0, linewidth=3)

plt.axhline(y=Y.max()*0.32, color='#000000', linestyle='dashed', linewidth=3)
...
# plt.savefig(SAVE_PATH+'test7_4_szt.svg', format='svg')
# plt.savefig(SAVE_PATH+'test7_4_szt.png', format='png')
plt.savefig(SAVE_PATH+'test7_4_szt.tif', format='tif', dpi=300)
plt.show()
...
for tt in [0.7, 0.34, 0.32, 0.26, 0.25, 0.24, 0.23, 0.19, 0.185]:
...
labels = hierarchy.fcluster(Z, t=Y.max()*0.3, criterion='distance')
labels -= 1
...
draw_pie(nums_cluster, labels=['MWLP ' + str(i) for i in range(1, k + 2)],
         filepath=SAVE_PATH+'test7_4_2_pie', formats=('svg', 'png', 'tif'))

draw_center_users(k+1, 4, center_users=np.array(user_mean), ymax=None, label1='MWLP', label2='TWLP',
                  filepath=SAVE_PATH+'test7_4_2_user', formats=('svg', 'png', 'tif'))
draw_center_users_barv(np.array(user_mean), label1='MWLP', label2='TWLP',
                       filepath=SAVE_PATH+'test7_4_2_user_cz', formats=('svg', 'png', 'tif'))
draw_center_users_barh(np.array(user_mean), label1='MWLP', label2='TWLP',
                       filepath=SAVE_PATH+'test7_4_2_user_sp', formats=('svg', 'png', 'tif'))
